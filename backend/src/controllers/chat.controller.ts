...
export class ChatController {
  ...
  public async chat(req: Request, res: Response): Promise<void> {
    try {
      ...
      // Add a special permission request tool
      const permissionTool = {
        name: 'request_mcp_permission',
        description: 'Request permission from the user before using an MCP tool. Always call this first!',
        inputSchema: {
          type: 'object',
          properties: {
            tool_name: {
              type: 'string',
              description: 'The name of the MCP tool you want to use',
            },
            tool_description: {
              type: 'string',
            ...
            purpose: {
              type: 'string',
              description: 'Clear explanation of why this tool is needed for the user\'s request',
            },
          },
          required: ['tool_name', 'tool_description', 'purpose'],
        },
        serverId: 'system',
      };
