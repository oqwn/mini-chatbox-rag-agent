...
export const ConversationSidebar: React.FC<ConversationSidebarProps> = ({
  ...
  return (
    <div className={`transition-all duration-300 ease-in-out ${isOpen ? 'w-80' : 'w-0'} flex-shrink-0`}>
      <div className={`h-full bg-white border-r shadow-lg flex flex-col overflow-hidden ${isOpen ? 'block' : 'hidden'}`}>
        {/* Header */}
