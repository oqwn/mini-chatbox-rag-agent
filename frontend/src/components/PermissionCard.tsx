  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ margin: '0 0 6px 0', fontWeight: 500, fontSize: '14px', color: '#333' }}>Purpose:</p>
